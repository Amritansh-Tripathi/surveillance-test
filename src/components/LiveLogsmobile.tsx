...
import LiveLogs2mobile from '@/components/LiveLogs2mobile'
import LiveCaptions from '@/components/LiveCaptions';
import { ScrollArea } from '@/components/ui/scroll-area';

const LiveLogsmobile = () => {
          ...
          <ScrollArea className="h-96 w-full rounded-md border ">
            <div className='grid grid-cols-1 md:grid-cols-3 gap-2 p-2 w-full h-full'>
              <div className='col-span-1 md:col-span-2 grid grid-rows-[auto_1fr] gap-2 p-0 w-full h-full'>
                ...
                <LiveLogs2mobile CameraName={selectedCamera?.CameraName || 'No Camera'} topicName={selectedCamera?.topic || null} />
              </div>

              <div className='col-span-1 p-0 grid grid-rows-[auto_1fr] gap-2 w-full h-full'>
                <h4 className="mb-4 text-sm font-medium leading-none self-start sticky top-0 z-10 pt-2 pb-4 ps-5 bg-[#121125] hidden md:flex">Live AI Alerts</h4>
