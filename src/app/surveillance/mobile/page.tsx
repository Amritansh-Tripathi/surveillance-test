...
import LiveLogsmobile from '@/components/LiveLogsmobile';
...
const Surveillance = () => {
  ...
  return (
    <div className='grid grid-cols-1 grid-rows-5 grid-flow-row-dense gap-4 md:grid-cols-5 md:gap-2 h-svh px-0 py-4 w-full'>
        ...
        <div className='grid col-span-1 row-span-5 grid-rows-5 gap-0 md:col-span-5 p-1 md:p-2'>

            <div className='row-span-2 h-full'>
            <SurveillanceGrid gridView={gridView} />
            </div>

            <div className='row-span-3 flex flex-col gap-3 justify-start items-start p-0'>
            {/* <p className='text-white font-extrabold'>Live Logs</p> */}
            <LiveLogsmobile/>
            </div>
        </div>
    </div>
