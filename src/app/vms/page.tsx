...
const fetchActivityData = async () => {
  const response = await fetch(`http://192.168.193.113:3000/api/oldapi/activity`);
...
const VMS = () => {
  ...
  return (
    <div className='flex flex-col gap-2 px-2 w-full pt-2 pb-16 justify-start items-start hidden-scrollbar'>
        ...
        <div className='grid grid-flow-row grid-rows-2 grid-cols-1 gap-2 justify-start items-start w-full h-full bg-none overflow-y-scroll hidden-scrollbar'>
            <div className='grid row-span-1 col-span-1 w-full h-full flex-col md:grid md:grid-cols-9 gap-2 md:grid-rows-2'>
                ...
                <div className='p-1 grid grid-cols-2 md:grid-cols-5 md:grid-flow-row-dense w-full h-full gap-x-12 md:gap-x-4 gap-y-7 md:gap-y-0 md:pr-10 relative'>
                  <div className='bg-[#4A2533] flex col-span-2 md:col-span-1 md:col-start-3 rounded-md p-2 md:p-2 md:max-h-36 md:w-fit md:h-fit relative hover:border hover:border-solid hover:border-[#FA5A7D]'>
                    ...
                    <Sheet>
                        ...
                        <SheetContent side="left" className='w-[340px] hidden-scrollbar'>
                          <SheetHeader className='flex items-start mb-2'>
                            <SheetTitle>Live Activities</SheetTitle>
              ...
              <div className='hidden md:rounded-md md:max-h-full w-full h-full md:p-0 md:col-span-7 gap-2 md:justify-between md:row-span-1 md:grid md:grid-cols-2'>
                <div className='md:bg-[#1B1B2E] md:rounded-md md:max-h-full flex w-full h-full flex-col md:p-3 md:flex-row md:col-span-1'>
                  <StackedBarChart/>
                </div>
                <div className=' md:max-h-full w-full h-full md:grid md:grid-cols-2 gap-2 md:p-1 md:col-span-1'>
                  <div className=' md:bg-[#1B1B2E] md:rounded-md flex flex-col col-span-1 w-full h-full justify-between md:gap-2 items-start p-1 md:p-2 border border-solid border-[#1B1B2E]'>
                    <p className='text-nowrap text-white font-bold text-lg md:text-3xl'>15</p>
                    <div className='flex flex-row md:flex-row justify-between items-center md:items-center md:gap-3 w-full'>
                      ...
                      <p className='text-nowrap text-white font-medium text-[10px] md:text-xl'>Exits Recorded</p>
                    </div>
                  </div>
                  <div className=' md:bg-[#1B1B2E] md:rounded-md flex col-span-1 flex-col w-full h-full justify-between md:gap-2 items-start p-1 md:p-2 border border-solid border-[#1B1B2E]'>
                    <p className='text-nowrap text-white font-bold text-lg md:text-3xl'>56</p>
                    <div className='flex flex-row md:flex-row justify-between items-center md:items-center md:gap-3 w-full'>
                      <div className='flex w-auto p-1 bg-[#3CD856] rounded-full h-6 md:w-11 md:h-11'>
                      <Image src='/PersonalEntryIcon.svg' alt='icon' width={18} height={18} className='flex w-full h-full' ></Image>
                      </div>
                      <p className='text-nowrap text-white font-medium text-[10px] md:text-xl'>Entries recorded</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className='hidden md:grid grid-cols-3 w-full h-full rounded-md grid-flow-row gap-2'>
              <Tabs defaultValue="personals" className="w-full h-full p-0 col-span-2">
